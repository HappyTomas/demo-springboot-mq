package win.leizhang.demo.mq.rabbitmq.test;
...
import win.leizhang.demo.mq.rabbitmq.Application;
...
public class BaseTestCase extends AbstractJUnit4SpringContextTests {
    ...
    static {
        System.setProperty("crtCurrentApplicationName", "demo-mq-rabbitmq-testCase");
        System.setProperty("server.port", "5032");
    }
